...
function Navbar() {
  const { theme, setHandleDrawer, darkMode, setHandleMode } =
    ...
    <div className="navbar">
      <div className="navbar--container">
        <div className="navbar--left">
          ...
          {darkMode ? (
            <img className="icon" src={sun} alt="sun" onClick={setHandleMode} />
          ) : (
            <img
              className="icon"
              src={moon}
              alt="moon"
              onClick={setHandleMode}
            />
          )}
        </div>
          ...
          <div className="navLink--container">
            ...
            <Fade left delay={200}>
              <NavLink to="/#skills" smooth={true} spy="true" duration={2000}>
                <div className={classes.drawerItem}>
                  <GiGears className={classes.drawerIcon} />
            ...
            <Fade left delay={200}>
              ...
              >
                <div className={classes.drawerItem}>
                  ...
                  <span className={classes.drawerLinks}>Achievement</span>
                </div>
              </NavLink>
            </Fade>
